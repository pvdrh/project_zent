            ...
            <div class="shp__cart__wrap">
                <div class="shp__single__product">
                    <div class="shp__pro__thumb">
                        <a href="#">
                            <img src="/frontend/images/product-2/sm-smg/1.jpg" alt="product images">
                        </a>
                    </div>
                ...
                <div class="shp__single__product">
                    <div class="shp__pro__thumb">
                        <a href="#">
                            <img src="/frontend/images/product-2/sm-smg/2.jpg" alt="product images">
                        </a>
                    </div>
                    <div class="shp__pro__details">
                ...
                <div class="row align-items__center">
                    ...
                    <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                        <div class="slide__thumb">
                            <img src="/frontend/images/slider/fornt-img/1.png" alt="slider images">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="single__slide animation__style01 slider__fixed--height">
            <div class="container">
                <div class="row align-items__center">
                    ...
                    <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                        <div class="slide__thumb">
                            <img src="/frontend/images/slider/fornt-img/2.png" alt="slider images">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                <div class="prize__inner">
                    <div class="prize__thumb">
                        <img src="/frontend/images/banner/big-img/1.png" alt="banner images">
                    </div>
            ...
            <div class="product__wrap clearfix">
                ...
                <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                    <div class="category">
                        <div class="ht__cat__thumb">
                            <a href="product-details.html">
                                <img src="/frontend/images/product/12.jpg" alt="product images">
                            </a>
                        </div>
                        <div class="fr__hover__info">
                            <ul class="product__action">
        ...
        <div class="row">
            <div class="ht__testimonial__activation clearfix">
                ...
                <div class="col-lg-6 col-md-6 single__tes">
                    <div class="testimonial">
                        <div class="testimonial__thumb">
                            <img src="/frontend/images/test/client/1.png" alt="testimonial images">
                        </div>
                ...
                <div class="col-lg-6 col-md-6 single__tes">
                    <div class="testimonial">
                        <div class="testimonial__thumb">
                            <img src="/frontend/images/test/client/2.png" alt="testimonial images">
                        </div>
                        <div class="testimonial__details">
        ...
        <div class="row mt--20">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="htc__best__product">
                    <div class="htc__best__pro__thumb">
                        <a href="product-details.html">
                            <img src="/frontend/images/product-2/sm-img-2/1.jpg" alt="small product">
                        </a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="htc__best__product">
                    <div class="htc__best__pro__thumb">
                        <a href="product-details.html">
                            <img src="/frontend/images/product-2/sm-img-2/2.jpg" alt="small product">
                        </a>
                    </div>
                    <div class="htc__best__product__details">
                        <h2><a href="product-details.html">dummy Product title</a></h2>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="htc__best__product">
                    <div class="htc__best__pro__thumb">
                        <a href="product-details.html">
                            <img src="/frontend/images/product-2/sm-img-2/3.jpg" alt="small product">
                        </a>
                    </div>
                    <div class="htc__best__product__details">
                        <h2><a href="product-details.html">dummy Product title</a></h2>
            ...
            <div class="col-md-12">
                <div class="ht__brand__inner">
                    <ul class="brand__list owl-carousel clearfix">
                        <li><a href="#"><img src="/frontend/images/brand/1.png" alt="brand images"></a></li>
                        <li><a href="#"><img src="/frontend/images/brand/2.png" alt="brand images"></a></li>
                        <li><a href="#"><img src="/frontend/images/brand/3.png" alt="brand images"></a></li>
                        <li><a href="#"><img src="/frontend/images/brand/4.png" alt="brand images"></a></li>
                        <li><a href="#"><img src="/frontend/images/brand/5.png" alt="brand images"></a></li>
                        <li><a href="#"><img src="/frontend/images/brand/5.png" alt="brand images"></a></li>
                        <li><a href="#"><img src="/frontend/images/brand/1.png" alt="brand images"></a></li>
                        <li><a href="#"><img src="/frontend/images/brand/2.png" alt="brand images"></a></li>
                    </ul>
